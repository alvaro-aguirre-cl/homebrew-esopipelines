class Esoreflex < Formula
  ...
  def install
    pkgshare.install "kepler", "common", "outreach", "kepler-tasks", "directors", "configuration-manager",
      "module-manager", "core", "event-state", "util", "component-library", "sms", "data-handling", "ssh",
      "io", "job", "repository", "authentication", "module-manager-gui", "gui", "authentication-gui",
      "ecogrid", "dataone", "dataturbine", "opendap", "actors", "display-redirect", "loader", "r",
      "build-area", "esoreflex", "esoreflex.jar"
